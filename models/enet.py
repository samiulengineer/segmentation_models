from tensorflow.keras.layers import Input, Conv2D, Conv2DTranspose, UpSampling2D, MaxPooling2D, concatenate, SpatialDropout2D, ZeroPadding2D, Permute, Add
from tensorflow.keras.layers import PReLU, ReLU, Activation
...
def enet(config):
    ...
    img_output = Conv2DTranspose(config['num_classes'], kernel_size=(2, 2), strides=(2, 2), kernel_initializer='he_normal', padding='same', name='image_output')(x)

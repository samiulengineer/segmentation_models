...
from tensorflow.keras.layers import Input, Conv2D, Conv2DTranspose, add, Activation, UpSampling2D, Dropout, BatchNormalization, MaxPooling2D, Lambda, multiply, concatenate

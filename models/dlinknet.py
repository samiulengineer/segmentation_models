from tensorflow.keras.layers import Conv2D, MaxPooling2D, Input, Conv2DTranspose, Add, Activation, BatchNormalization
...
"""
DLINKNET Model
Paper: https://ieeexplore.ieee.org/document/8575492
# ----------------------------------------------------------------------------------------------
"""
...
def dlinknet(config):
    ...
    outputs = Conv2D(config['num_classes'], (1, 1), activation='sigmoid')(final)
